...
{
    public partial class FillupLivestock : Form
    {
        ...
        private void FillupLivestock_Load(object sender, EventArgs e)
        {
            GetUsers();
        }

        private void dgvLivestock_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0) // Ensure a valid row is clicked
            {
                DataGridViewRow row = dgvLivestock.Rows[e.RowIndex];
        ...
        private void Save_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO Livestock (Category, Item, Quantity, Location, Obtain_Date, Expiration_Date, Notes, Item_Cost, Item_Value) " +
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            if (dgvLivestock.CurrentRow == null)
            {
            ...
            int selectedID = Convert.ToInt32(dgvLivestock.CurrentRow.Cells["CropsID"].Value); // Replace "CropID" with your actual primary key column name

            // Define the SQL query for updating the record
            string query = "UPDATE Livestock SET Category = @category, Item = @item, Quantity = @quantity, Location = @location, " +
                           "Obtain_Date = @obtainDate, Expiration_Date = @expirationDate, Notes = @notes, Item_Cost = @itemcost, Item_Value = @itemvalue WHERE LivestockID = @id";
        ...
        private void Delete_Click(object sender, EventArgs e)
        {
            ...
            int selectedID = Convert.ToInt32(dgvLivestock.CurrentRow.Cells["LivestockID"].Value); // Replace "ID" with your primary key column name
            ...
            if (confirmResult == DialogResult.Yes)
            {
                ...
                string query = "DELETE FROM Livestock WHERE LivestockID = @id";  // Replace 'ID' with your actual primary key column name
        ...
        private void tbSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dv.RowFilter = $@"
        Convert(LivestockID, 'System.String') LIKE '%{searchValue}%'
