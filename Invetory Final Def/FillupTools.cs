...
{
    public partial class FillupTools : Form
    {
        ...
        private void FillupTools_Load(object sender, EventArgs e)
        {
            GetUsers();
        }
        ...
        private void Save_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO Tools (Category, Item, Quantity, Location, Obtain_Date, Expiration_Date, Notes, Item_Cost, Item_Value) " +
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            int selectedID = Convert.ToInt32(dgvTools.CurrentRow.Cells["ToolsID"].Value); // Replace "ToolsID" with your actual primary key column name

            // Define the SQL query for updating the record
            string query = "UPDATE Tools SET Category = @category, Item = @item, Quantity = @quantity, Location = @location, " +
        ...
        private void Delete_Click(object sender, EventArgs e)
        {
            ...
            int selectedID = Convert.ToInt32(dgvTools.CurrentRow.Cells["ToolsID"].Value); // Replace "ID" with your primary key column name
            ...
            if (confirmResult == DialogResult.Yes)
            {
                ...
                string query = "DELETE FROM Tools WHERE ToolsID = @id";  // Replace 'ID' with your actual primary key column name
